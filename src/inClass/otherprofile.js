...
export class OtherProfile extends React.Component {
    ...
    componentDidMount() {
        //here we figure out what the user wrote in the url
        console.log(this.props.pramas.id);
        //this is the way we can recieve the id
        //the user wrote/passed to the URL.
        //this is all we need to pass to the axios request.
    }
